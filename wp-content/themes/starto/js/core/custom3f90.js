jQuery(document).ready(function () {
  ...
  mobx = new ModuloBox({
    // options
    mediaSelector:
      '.starto_gallery_lightbox, .woocommerce-product-gallery__image a',
    scrollToZoom: true,
  ...
  jQuery(window).resize(function () {
    ...
    if (jQuery(this).width() < 768) {
      ...
      jQuery('#page-content-wrapper .sidebar-wrapper').trigger(
        'sticky_kit:detach'
      );
    } else {
      ...
      if (startoParams.headercontent == 'menu') {
        jQuery('#wrapper').css(
          'paddingTop',
          parseInt(jQuery('.main-menu-wrapper').height()) + 'px'
        );
      } else {
        jQuery('#wrapper').css(
          'paddingTop',
          parseInt(jQuery('#elementor-header').height()) + 'px'
        );
      }
    ...
    if (
      ...
      jQuery('#page-content-wrapper').css(
        'marginTop',
  ...
  jQuery('#menu_expand_wrapper a').on('click', function () {
    ...
    jQuery('#menu-border-wrapper select')
  ...
  if (startoParams.topbar == 0) {
    ...
    var topBarHeight = parseInt(
      jQuery('.main-menu-wrapper').height() -
        jQuery('.main-menu-wrapper .above-top-menu-bar').height()
    );
  }
  ...
  var menuPaddingTop = parseInt(
    jQuery('#menu-wrapper div .nav li > a').css('paddingTop')
  );
  var menuPaddingBottom = parseInt(
    jQuery('#menu-wrapper div .nav li > a').css('paddingBottom')
  );
  var SearchPaddingTop = parseInt(
    jQuery('.top-menu-bar #searchform button').css('paddingTop')
  );
  ...
  if (menuLayout != 'leftmenu' || jQuery(window).width() <= 960) {
    jQuery(window).scroll(function () {
      if (
        ...
        jQuery('html').data('style') != 'fullscreen_white'
      ) {
        if (jQuery(this).scrollTop() >= 100) {
          ...
          jQuery('#custom_logo_transparent').css(
            'marginTop',
            parseInt(logoTransMargin) + 'px'
          );

          jQuery('#menu-wrapper div .nav > li > a').css(
            'paddingTop',
            menuPaddingTop + 'px'
          );
          jQuery('#menu-wrapper div .nav > li > a').css(
  ...
  jQuery('#mobile-nav-icon, #elementor_mobile_nav, .elementor_mobile_nav').on(
    'click',
    function () {
  ...
  if (isFooterReveal != '') {
    var bumpIt = function () {
        if (jQuery(window).width() > 1024) {
          jQuery('#wrapper').css(
            'margin-bottom',
            parseInt(jQuery('#footer-wrapper').height())
          );
        } else {
  ...
  jQuery('.widget_nav_menu ul > li.menu-item-has-children').on(
    'click',
    function () {

...
(function ($) {
  ...
  $(window).on('elementor/frontend/init', function () {
    ...
    jQuery('img.lazy').each(function () {
      ...
      jQuery(this).Lazy({
        onFinishedAll: function () {
          currentImg
            .parent('div.post-featured-image-hover')
            .removeClass('lazy');
          currentImg
            .parent('.starto_gallery_lightbox')
            .parent('div.gallery-grid-item')
            .removeClass('lazy');
        },
      });
    });
    ...
    jQuery('#page-content-wrapper .elementor-widget-image.animation').each(
      function () {
        jQuery(this).smoove({
          offset: '30%',
        });
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope) {
        ...
        if (typeof widgetExt != 'undefined') {
          ...
          if (
            typeof widgetExt.starto_ext_is_scrollme != 'undefined' &&
            widgetExt.starto_ext_is_scrollme == 'true'
          ) {
            var scrollArgs = {};

            if (
              typeof widgetExt.starto_ext_scrollme_scalex.size != 'undefined' &&
              widgetExt.starto_ext_scrollme_scalex.size != 1
            ) {
              scrollArgs['scaleX'] = widgetExt.starto_ext_scrollme_scalex.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_scaley.size != 'undefined' &&
              widgetExt.starto_ext_scrollme_scaley.size != 1
            ) {
              scrollArgs['scaleY'] = widgetExt.starto_ext_scrollme_scaley.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_scalez.size != 'undefined' &&
              widgetExt.starto_ext_scrollme_scalez.size != 1
            ) {
              scrollArgs['scaleZ'] = widgetExt.starto_ext_scrollme_scalez.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_rotatex.size !=
                'undefined' &&
              widgetExt.starto_ext_scrollme_rotatex.size != 0
            ) {
              scrollArgs['rotateX'] =
                widgetExt.starto_ext_scrollme_rotatex.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_rotatey.size !=
                'undefined' &&
              widgetExt.starto_ext_scrollme_rotatey.size != 0
            ) {
              scrollArgs['rotateY'] =
                widgetExt.starto_ext_scrollme_rotatey.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_rotatez.size !=
                'undefined' &&
              widgetExt.starto_ext_scrollme_rotatez.size != 0
            ) {
              scrollArgs['rotateY'] =
                widgetExt.starto_ext_scrollme_rotatez.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_translatex.size !=
                'undefined' &&
              widgetExt.starto_ext_scrollme_translatex.size != 0
            ) {
              scrollArgs['x'] = widgetExt.starto_ext_scrollme_translatex.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_translatey.size !=
                'undefined' &&
              widgetExt.starto_ext_scrollme_translatey.size != 0
            ) {
              scrollArgs['y'] = widgetExt.starto_ext_scrollme_translatey.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_translatez.size !=
                'undefined' &&
              widgetExt.starto_ext_scrollme_translatez.size != 0
            ) {
              scrollArgs['z'] = widgetExt.starto_ext_scrollme_translatez.size;
            }

            if (
              typeof widgetExt.starto_ext_scrollme_smoothness.size !=
              'undefined'
            ) {
              scrollArgs['smoothness'] =
                widgetExt.starto_ext_scrollme_smoothness.size;
            }
            ...
            if (typeof widgetExt.starto_ext_scrollme_disable != 'undefined') {
              ...
              jQuery(window).resize(function () {
                if (widgetExt.starto_ext_scrollme_disable == 'mobile') {
                  if (
                    isMobileDevice() ||
                    parseInt(jQuery(window).width()) < 501
                  ) {
                    $scope.addClass('noanimation');
                  } else {
          ...
          if (
            typeof widgetExt.starto_ext_is_smoove != 'undefined' &&
            widgetExt.starto_ext_is_smoove == 'true'
          ) {
            ...
            $scope.smoove({
              ...
              rotateX:
                parseInt(widgetExt.starto_ext_smoove_rotatex.size) + 'deg',
              rotateY:
                parseInt(widgetExt.starto_ext_smoove_rotatey.size) + 'deg',
              rotateZ:
                parseInt(widgetExt.starto_ext_smoove_rotatez.size) + 'deg',

              moveX:
                parseInt(widgetExt.starto_ext_smoove_translatex.size) + 'px',
              moveY:
                parseInt(widgetExt.starto_ext_smoove_translatey.size) + 'px',
              moveZ:
                parseInt(widgetExt.starto_ext_smoove_translatez.size) + 'px',
              ...
              perspective: parseInt(
                widgetExt.starto_ext_smoove_perspective.size
              ),
            ...
            if (typeof widgetExt.starto_ext_smoove_duration != 'undefined') {
              $scope.css(
                'transition-duration',
                parseInt(widgetExt.starto_ext_smoove_duration) + 'ms'
              );
            }
          ...
          if (
            typeof widgetExt.starto_ext_is_parallax_mouse != 'undefined' &&
            widgetExt.starto_ext_is_parallax_mouse == 'true'
          ) {
            ...
            $scope
              ...
              .attr(
                'data-depth',
                parseFloat(widgetExt.starto_ext_is_parallax_mouse_depth.size)
              );
          ...
          if (
            typeof widgetExt.starto_ext_is_infinite != 'undefined' &&
            widgetExt.starto_ext_is_infinite == 'true'
          ) {
            var animationClass = '';
            var keyframeName = '';
            var animationCSS = '';
            ...
            if (typeof widgetExt.starto_ext_infinite_easing != 'undefined') {
              animationCSS +=
                'cubic-bezier(' + widgetExt.starto_ext_infinite_easing + ')';
            }
            //alert(animationCSS);
            $scope.css({
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-blog-posts.default',
      function ($scope) {
        jQuery(function ($) {
          jQuery('img.lazy').each(function () {
            var currentImg = jQuery(this);
          ...
          jQuery('.layout-masonry').each(function () {
            ...
            grid.imagesLoaded().done(function () {
              ...
              jQuery('.layout-masonry .blog-posts-masonry').each(function (
                index
              ) {
                setTimeout(function () {
                  jQuery('.layout-masonry .blog-posts-masonry')
                    .eq(index)
                    .addClass('is-showing');
                }, 250 * index);
              });
          ...
          jQuery('.layout-metro_masonry').each(function () {
            ...
            grid.imagesLoaded().done(function () {
              ...
              jQuery('.layout-metro_masonry .blog-posts-metro').each(function (
                index
              ) {
                setTimeout(function () {
                  jQuery('.layout-metro_masonry .blog-posts-metro')
                    .eq(index)
                    .addClass('is-showing');
                }, 100 * index);
              });
            ...
            jQuery(
              '.post-metro-left-wrapper img.lazy_masonry, .layout-metro_masonry img.lazy_masonry'
            ).each(function () {
              var currentImg = jQuery(this);
              currentImg
                .parent('div.post-featured-image-hover')
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-gallery-grid.default',
      function ($scope) {
        jQuery('img.lazy').each(function () {
          var currentImg = jQuery(this);
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-gallery-masonry.default',
      function ($scope) {
        jQuery(function ($) {
          jQuery('.starto-gallery-grid-content-wrapper.do-masonry').each(
            function () {
              var grid = jQuery(this);
              ...
              grid.imagesLoaded().done(function () {
                ...
                jQuery(
                  '.starto-gallery-grid-content-wrapper.do-masonry .gallery-grid-item'
                ).each(function (index) {
                  setTimeout(function () {
                    jQuery('.do-masonry .gallery-grid-item')
                      .eq(index)
                      .addClass('is-showing');
                  }, 100 * index);
                });
              ...
              jQuery(
                '.starto-gallery-grid-content-wrapper.do-masonry img.lazy_masonry'
              ).each(function () {
                var currentImg = jQuery(this);
                currentImg
                  .parent('div.post-featured-image-hover')
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-gallery-justified.default',
      function ($scope) {
        jQuery(function ($) {
          jQuery('img.lazy').each(function () {
            var currentImg = jQuery(this);
          ...
          jQuery('.starto-gallery-grid-content-wrapper.do-justified').each(
            function () {
              var grid = jQuery(this);
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-gallery-fullscreen.default',
      function ($scope) {
        jQuery(function ($) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-vertical-parallax.default',
      function ($scope) {
        jQuery(function ($) {
          jQuery('body').addClass('elementor-fullscreen');
          ...
          function nextItem() {
            var $previousSlide = jQuery('.parallax-slide-background').eq(
              currentSlideNumber - 1
            );
            $previousSlide
              .css('transform', 'translate3d(0,-130vh,0)')
              .find('.parallax-slide-content-wrapper')
          ...
          function currentSlideTransition() {
            var $currentSlide = jQuery('.parallax-slide-background').eq(
              currentSlideNumber
            );
            $currentSlide
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-gallery-horizontal.default',
      function ($scope) {
        ...
        jQuery('.horizontal-gallery-wrapper').each(function () {
          ...
          if (fullscreen != 0) {
            ...
            $carousel
              .find('.horizontal-gallery-cell')
              .css('height', sliderHeight + 'px');
            $carousel
              .find('.horizontal-gallery-cell-img')
              .css('height', sliderHeight + 'px');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-horizontal.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-animated-frame.default',
      function ($scope) {
          ...
          navigate(dir = 'next') {
            ...
            const animateSlides = () => {
              return new Promise((resolve, reject) => {
                ...
                anime({
                  targets: [
                    newSlide.querySelector('.slide-title'),
                    newSlide.querySelector('.slide-desc'),
                    newSlide.querySelector('.slide-link'),
                  ],
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-room.default',
      function ($scope) {
        jQuery('body').addClass('elementor-fullscreen');
        ...
        var DOM = {};
        // The loader.
        DOM.loader = document.querySelector(
          '.room-slider-wrapper .overlay--loader'
        );
        // The room wrapper. This will be the element to be transformed in order to move around.
        DOM.scroller = document.querySelector(
          '.room-slider-wrapper .container > .scroller'
        );
        // The rooms.
        if (DOM.scroller) {
        ...
        if (DOM.content) {
          ...
          DOM.nav = {
            leftCtrl: DOM.content.querySelector(
              '.room-slider-wrapper nav > .btn--nav-left'
            ),
            rightCtrl: DOM.content.querySelector(
              '.room-slider-wrapper nav > .btn--nav-right'
            ),
          };
          // Content slides.
          DOM.slides = [].slice.call(
            DOM.content.querySelectorAll('.slides > .slide')
          );
        }
        ...
        function addAdjacentRooms() {
          ...
          var room = DOM.rooms[currentRoom],
            // Adjacent rooms.
            nextRoom =
              DOM.rooms[currentRoom < totalRooms - 1 ? currentRoom + 1 : 0],
            prevRoom =
              DOM.rooms[currentRoom > 0 ? currentRoom - 1 : totalRooms - 1];

          // Position the adjacent rooms.
          nextRoom.style.transform =
            'translate3d(100%,0,0) translate3d(3px,0,0)';
          nextRoom.style.opacity = 1;
          prevRoom.style.transform =
            'translate3d(-100%,0,0) translate3d(-3px,0,0)';
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-multi-layouts.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-velo.default',
      function ($scope) {
        jQuery('body').addClass('elementor-fullscreen');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-popout.default',
      function ($scope) {
        jQuery('body').addClass('elementor-fullscreen');

        function goToSlide(number) {
          $('.slider-slide').removeClass('slider-slide--active');
          $('.slider-slide[data-slide=' + number + ']').addClass(
            'slider-slide--active'
          );
        }
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-clip-path.default',
      function ($scope) {
        jQuery('body').addClass('elementor-fullscreen');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-gallery-preview.default',
      function ($scope) {
        jQuery('body').addClass('elementor-fullscreen');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-split-slick.default',
      function ($scope) {
        jQuery('body').addClass('elementor-fullscreen');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-transitions.default',
      function ($scope) {
        jQuery('body').addClass('elementor-fullscreen');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-property-clip.default',
      function ($scope) {
        jQuery('.slider-property-clip-wrapper').each(function () {
          ...
          nav.on('click', 'a', function (event) {
            event.preventDefault();
            $(this)
              .addClass('current-dot')
              .siblings()
              .removeClass('current-dot');
            slides
              .eq($(this).index())
              .addClass('current')
              .removeClass('prev')
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-slice.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-flip.default',
      function ($scope) {
        jQuery('body').addClass('elementor-fullscreen');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-split-carousel.default',
      function ($scope) {
          ...
          var paintFaces = function paintFaces() {
            $('.spinner-face').each(function (i, el) {
              ...
              $el
                ...
                .css(
                  'backgroundImage',
                  'url(' + getBase64PixelByColor(color) + ')'
                );
            });
          };
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-horizontal-timeline.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-background-list.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-masonry.default',
      function ($scope) {
        jQuery(function ($) {
          jQuery('.portfolio-masonry-content-wrapper.do-masonry').each(
            function () {
              var grid = jQuery(this);
              var cols = grid.attr('data-cols');
              cols = parseInt(cols);
              ...
              jQuery('.portfolio-masonry-container').each(function () {
                ...
                containderDiv.find('.filter-tag-btn').on('click', function () {
                  ...
                  var gridDiv = containderDiv.find(
                    '.portfolio-masonry-content-wrapper.do-masonry'
                  );
                  ...
                  gridDiv
                    .find('.portfolio-masonry-grid-wrapper')
                    .not('.' + selectedClass)
                    .fadeOut()
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-masonry-grid.default',
      function ($scope) {
        jQuery(function ($) {
          jQuery('.portfolio-masonry-content-wrapper.do-masonry').each(
            function () {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-timeline.default',
      function ($scope) {
        var timelines = jQuery('.cd-horizontal-timeline');
        var eventsMinDistance = timelines.attr('data-spacing');
    ...
    //Start execute javascript for background list
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-timeline-vertical.default',
      function ($scope) {
        jQuery('.portfolio-timeline-vertical-content-wrapper').each(
          function () {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-parallax.default',
      function ($scope) {
        ...
        jQuery(document).ready(function () {
          ...
          jQuery('.slider-parallax-wrapper .arrows .arrow').on(
            'click',
            function () {
              slideshowNext(
                jQuery(this).closest('.slider-parallax-wrapper'),
                jQuery(this).hasClass('prev')
              );
            }
          );

          jQuery('.slider-parallax-wrapper .pagination .item').on(
            'click',
            function () {
              slideshowSwitch(
                jQuery(this).closest('.slider-parallax-wrapper'),
          ...
          jQuery('.slider-parallax-wrapper .pagination').on(
            'check',
            function () {
              var slideshow = jQuery(this).closest('.slider-parallax-wrapper');
              var pages = jQuery(this).find('.item');
              var index = slideshow
                .find('.slider_parallax_slides .is-active')
                .index();
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-distortion-grid.default',
      function ($scope) {
        Array.from(
          document.querySelectorAll('.distortion-grid-item-img')
        ).forEach((el) => {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-animated.default',
      function ($scope) {
        ...
        var Slideshow = (function () {
          function Slideshow() {
            ...
            this.$el = options.$el;
            this.maxSlide = this.$el.find(
              jQuery('.js-slider-home-slide')
            ).length;
              ...
              value: function init() {
                ...
                if (this.showPagination) {
                  ...
                  for (var i = 0; i < this.maxSlide; i++) {
                    var item =
                      '<span class="pagination-item js-pagination-item ' +
                      (i === 0 ? 'is-current' : '') +
                      '" data-slide=' +
                      (i + 1) +
                      '>' +
            ...
            },
            {
              ...
              value: function goToSlide(index) {
                ...
                var newCurrent = this.$el.find(
                  '.js-slider-home-slide[data-slide="' +
                    this.currentSlide +
                    '"]'
                );
                var newPrev =
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-fadeup.default',
      function ($scope) {
        function init(item) {
          ...
          if (items.length > 1)
            items[items.length - 1].className = 'prev-slide';
        ...
        [].slice
          .call(document.querySelectorAll('.fadeup-slider-wrapper'))
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-motion-reveal.default',
      function ($scope) {
        // The Slide class.
        class Slide {
          constructor(el) {
            ...
            this.DOM.revealer =
              this.DOM.imgWrap.querySelector('.slide-img-reveal');
            // The title element.
            ...
            this.DOM.preview = {
              ...
              revealer: this.DOM.el.querySelector(
                '.preview-img-wrap > .preview-img-reveal'
              ),
          ...
          toggle(action, direction) {
            ...
            return new Promise((resolve, reject) => {
              let revealerOpts = {
                delay:
                  action === 'hide' ? 0 : this.config.animation.duration / 2,
        ...
        class Slideshow {
          constructor(el) {
            ...
            this.DOM.previewCtrl =
              this.DOM.el.querySelector('.slidenav-preview');
            // The slides.
            this.slides = [];
            Array.from(this.DOM.el.querySelectorAll('.slide')).forEach(
              (slideEl) => this.slides.push(new Slide(slideEl))
            );
          ...
          toggleNavCtrls(action) {
            TweenMax.to([this.DOM.prevCtrl, this.DOM.nextCtrl], 0.5, {
              ...
              onStart: () =>
                (this.DOM.prevCtrl.style.pointerEvents =
                  this.DOM.nextCtrl.style.pointerEvents =
        ...
        const slideshow = new Slideshow(
          document.querySelector('.motion-reveal-slider-wrapper.slideshow')
        );
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-testimonial-card.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-image-carousel.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-grid.default',
      function ($scope) {
        jQuery('.portfolio_grid_container').each(function () {
          ...
          containderDiv.find('.filter-tag-btn').on('click', function () {
            ...
            setTimeout(function () {
              ...
              var count = gridDiv.find(
                '.portfolio-grid-wrapper.scale-anm'
              ).length;

              gridDiv
                .find('.portfolio-grid-wrapper.scale-anm')
                .each(function (index) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-grid-overlay.default',
      function ($scope) {
        jQuery('.portfolio-grid-overlay-container').each(function () {
          ...
          containderDiv
            .find('.portfolio-grid-wrapper-overlay')
            .imagesLoaded()
            .always(function () {
              var currentWrapper = containderDiv.find(
                '.portfolio-grid-wrapper-overlay'
              );
              var currentImg = containderDiv.find(
                '.portfolio-grid-wrapper-overlay img'
              );
          ...
          containderDiv.find('.filter-tag-btn').on('click', function () {
            ...
            setTimeout(function () {
              ...
              gridDiv
                .find('.portfolio-grid-wrapper-overlay.last')
                .removeClass('last');
              var count = gridDiv.find(
                '.portfolio-grid-wrapper-overlay.scale-anm'
              ).length;

              gridDiv
                .find('.portfolio-grid-wrapper-overlay.scale-anm')
                .each(function (index) {
                  var lastIndex = parseInt(index + 1);
                  if (lastIndex % column == 0) {
                    jQuery(this).addClass('last');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-3d-overlay.default',
      function ($scope) {
        jQuery('.portfolio-grid-overlay-container').each(function () {
          var containderDiv = jQuery(this);
          var selectedClass = '';
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-classic.default',
      function ($scope) {
        jQuery('.portfolio-classic-container').each(function () {
          ...
          containderDiv.find('.filter-tag-btn').on('click', function () {
            ...
            gridDiv
              .find('.portfolio-classic-grid-wrapper')
              .not('.' + selectedClass)
              .fadeOut()
              .removeClass('scale-anm');
            ...
            setTimeout(function () {
              ...
              gridDiv
                .find('.portfolio-classic-grid-wrapper.last')
                .removeClass('last');
              var count = gridDiv.find(
                '.portfolio-classic-grid-wrapper.scale-anm'
              ).length;

              gridDiv
                .find('.portfolio-classic-grid-wrapper.scale-anm')
                .each(function (index) {
                  var lastIndex = parseInt(index + 1);
                  if (lastIndex % column == 0) {
                    jQuery(this).addClass('last');
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-contain.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-navigation-menu.default',
      function ($scope) {
        jQuery('.themegoods-navigation-wrapper .nav li.menu-item').hover(
          function () {
            jQuery(this).children('ul:first').addClass('visible');
            jQuery(this).children('ul:first').addClass('hover');

            jQuery(this)
              .children('.elementor-megamenu-wrapper:first')
              .addClass('visible');
            jQuery(this)
              .children('.elementor-megamenu-wrapper:first')
              .addClass('hover');
        ...
        jQuery('.themegoods-navigation-wrapper .nav li.menu-item')
          .children('ul:first.hover')
          .hover(
            function () {
        ...
        jQuery('.themegoods-navigation-wrapper .nav li.menu-item')
          .children('.elementor-megamenu-wrapper.hover')
          .hover(
            function () {
              jQuery(this).stop().addClass('visible');
            },
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-video-grid.default',
      function ($scope) {
        ...
        jQuery(
          '.portfolio-classic-content-wrapper.video-grid .video-grid-wrapper'
        ).each(function () {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-portfolio-coverflow.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-glitch-slideshow.default',
      function ($scope) {
        class Slide {
          constructor(el) {
            this.DOM = { el: el };
          ...
          layout() {
            this.DOM.slideImg.innerHTML =
              `<div class='glitch-img' style='background-image: ${this.DOM.slideImg.style.backgroundImage};'></div>`.repeat(
                5
              );
            this.DOM.glitchImgs = Array.from(
              this.DOM.slideImg.querySelectorAll('.glitch-img')
            );
          }
        ...
        class GlitchSlideshow {
          constructor(el) {
            this.DOM = { el: el };
            this.DOM.slides = Array.from(
              this.DOM.el.querySelectorAll('.slide')
            );
            this.slidesTotal = this.DOM.slides.length;
            this.slides = [];
        ...
        imagesLoaded(
          ...
          () => {
            ...
            const nav = Array.from(
              document.querySelectorAll('.slide-nav-button')
            );
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-music-player.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-mouse-driven-vertical-carousel.default',
      function ($scope) {
          ...
          initCursor() {
            ...
            if (jQuery(window).width() > 1024) {
              ...
              this.getCarousel().addEventListener(
                ...
                (event) => {
                  this.posY =
                    parseInt(event.pageY - carouselPosY) -
                    this.getCarousel().offsetTop;
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-synchronized-carousel.default',
      function ($scope) {
        jQuery('.synchronized-carousel-slider-wrapper').each(function () {
          ...
          var buttonTitles = JSON.parse(
            jQuery(this).attr('data-slidebuttontitles')
          );
          var buttonUrls = JSON.parse(
            jQuery(this).attr('data-slidebuttonurls')
          );
          ...
          var msImages = new MomentumSlider({
            ...
            rangeContent: function (i) {
              return (
                '<div class="ms-slide-image-container"><div class="ms-slide-image" style="background-image: url(\'' +
                images[i] +
                '\')"></div></div>'
              );
            },
            ...
            change: function (newIndex, oldIndex) {
              ...
              paginationItems[newIndex].classList.add(
                'pagination-item--active'
              );
            },
          });
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-flip-box.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-slider-zoom.default',
      function ($scope) {
        var _createClass = (function () {
          function defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-course-grid.default',
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-search.default',
      function ($scope) {
        jQuery('.starto-search-icon').each(function () {
          ...
          iconInput.bind('click', function () {
            ...
            setTimeout(function () {
              jQuery('#' + openDiv)
                .find('.tg_search_form.autocomplete_form')
                .find('input#s')
                .trigger('focus');
            }, 300);
          });
            ...
            formInput.on('input', function () {
              if (jQuery(this).val().length > 1) {
                jQuery.ajax({
                  ...
                  type: 'POST',
                  data:
                    'action=starto_ajax_search_result&' +
                  ...
                  success: function (results) {
                    ...
                    if (results != '') {
                      ...
                      jQuery('#' + resultDiv + ' ul li a').mousedown(
                        function () {
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-service-grid.default',
      function ($scope) {
        jQuery('.service-grid-wrapper')
          .mouseover(function () {
            var dataHoverY = jQuery(this).attr('data-hoverY');
            jQuery(this)
              .find('.header-wrap')
              .css('transform', 'translateY(-' + dataHoverY + 'px)');
          })
          .mouseleave(function () {
            jQuery(this)
              .find('.header-wrap')
    ...
    elementorFrontend.hooks.addAction(
      'frontend/element_ready/starto-pricing-table.default',
      function ($scope) {

    ...
    n(172),
      ...
      (e.exports = elementorModules.frontend.handlers.Base.extend({
        ...
        getDefaultElements: function () {
          ...
          return (
            (t.$mainSwiperSlides = t.$swiperContainer.find(e.swiperSlide)), t
          );
        },
        ...
        onElementChange: function (e) {
          1 >= this.getSlidesCount() ||
            (0 === e.indexOf('width') && this.swiper.update(),
            0 === e.indexOf('space_between') &&
              this.updateSpaceBetween(this.swiper, e));
        },
      ...
      u = (function (e) {
        ...
        function n() {
          ...
          for (var i = arguments.length, o = new Array(i), a = 0; a < i; a++)
            o[a] = arguments[a];
          return (
            ((e = t.call.apply(t, [this].concat(o))).checkScroll =
      ...
      u = (function (e) {
        ...
        function n() {
          ...
          for (var i = arguments.length, o = new Array(i), a = 0; a < i; a++)
            o[a] = arguments[a];
          return (
            ((e = t.call.apply(t, [this].concat(o))).checkClick =
      ...
      u = (function (e) {
        ...
        function n() {
          ...
          for (var i = arguments.length, o = new Array(i), a = 0; a < i; a++)
            o[a] = arguments[a];
          return (
            ((e = t.call.apply(t, [this].concat(o))).restartTimer =
      ...
      u = (function (e) {
        ...
        function n() {
          ...
          for (var i = arguments.length, o = new Array(i), a = 0; a < i; a++)
            o[a] = arguments[a];
          return (
            ((e = t.call.apply(t, [this].concat(o))).detectExitIntent =
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = this.elements.$headings[e].id,
                  i =
                    this.elements.$headings[e].closest('.elementor-widget').id,
                  r = '';
                return (
                  n ? (r = n) : i && (r = i),
                  n || i
    ...
    (i = r.extend({
      ...
      onElementChange: function (e) {
        1 >= this.getSlidesCount() ||
          (this.isSlideshow()
            ? (0 === e.indexOf('width') &&
                (this.swiper.update(), this.thumbsSwiper.update()),
              0 === e.indexOf('space_between') &&
                this.updateSpaceBetween(this.thumbsSwiper, e))
